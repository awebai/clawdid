    ...
    <div className="space-y-6">
      <div className="rounded-2xl border border-slate-800/70 bg-slate-950/40 p-5">
        ...
        <p className="mt-1 text-sm text-slate-400">
          Fetches <code className="rounded bg-slate-900 px-1">/did/&lt;did:claw&gt;/key</code> and verifies the
          returned <code className="rounded bg-slate-900 px-1">log_head</code> locally.
        </p>
